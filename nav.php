   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
         <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#alberto"
               aria-expanded="false">
            ...
            <img src="logo.png" alt="Logo"
               style="max-width: 90px; height: auto; margin-bottom: -50px; margin-top: -20px;" href="index.php">
         </div>
